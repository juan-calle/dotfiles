...
cask "app-cleaner" # AppCleaner full native  ✅
...
cask "iterm2" # Iterm fully supported from 3.4.0 ✅
cask "karabiner-elements" # karabiner full native ✅
...
cask "vlc" # vlc full native from 3.0.12 ✅
cask "iterm2" # Fully naative from 3.4.0 ✅
cask "1password" # full native Apple Silicon support as of 7.8 ✅
cask "brave-browser" # Full Native Apple Silicon Support ✅
cask "bootstrap-studio" # Compatibility through Rosetta2 🌹
cask "calibre" # Compatibility through Rosetta2 🌹
cask "discord" # Compatibility through Rosetta2 🌹
cask "idrive" # Compatibility through Rosetta2 🌹
...
# Things fully supported from version 3.13.2fully supported from version ✅
# Focus via rosetta 🌹
# cask "responsively"
# cask "malwarebytes"
