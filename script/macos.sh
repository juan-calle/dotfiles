...
sudo scutil --set ComputerName "jc"
sudo scutil --set HostName "jc"
# sudo scutil --set LocalHostName "jclocalhost"
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "jc"
...
# Transmission.app                                                            #
###############################################################################
# Use `~/DocumDownloads/Torrents` to store incomplete downloads
